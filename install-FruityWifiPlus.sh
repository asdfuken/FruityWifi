...
cd ../
mv /usr/share/ .BAK.$cmd
cp -a FruityWifiPlus /usr/share/
ln -s /usr/share/FruityWifiPlus/www /var/www/FruityWifiPlus
ln -s /usr/share/FruityWifiPlus/logs /var/www/FruityWifiPlus/logs
mkdir /var/www/tmp
chown www-data.www-data /var/www/tmp
chmod  777 /var/www/tmp
chmod 755 /usr/share/FruityWifiPlus/squid.inject/poison.pl
ln -s /usr/share/FruityWifiPlus/www.site /var/www/site
chown -R www-data.www-data /usr/share/FruityWifiPlus/www.site
chmod 777 /usr/share/FruityWifiPlus/www.site/data.txt
chmod 777 /usr/share/FruityWifiPlus/www.site/inject/data.txt

#mkdir /FruityWifiPlus/logs/kismet
#mkdir /FruityWifiPlus/logs/sslstrip

# BIN
cd /usr/share/FruityWifiPlus/bin/
